...
public class Constants {
	...
	public static final String PROP_DCTERMS_REFERENCES = NS_DCTERMS + "references";
	public static final String PROP_DCTERMS_IS_REFERENCED_BY = NS_DCTERMS + "isReferencedBy";
